...
{
 "use strict";
 var assignment4,Client,assignment4_Templates,WebSharper,Concurrency,Remoting,AjaxRemotingProvider,UI,Var$1,Templating,Runtime,Server,ProviderBuilder,Handler,TemplateInstance,Client$1,Templates;
 ...
 Client.Main$19$20=function(rvReversed)
 {
  return function(e)
  {
   ...
   {
    return Concurrency.Bind((new AjaxRemotingProvider.New()).Async("assignment4:assignment4.Server.DoSomething:1689443245",[e.Vars.Hole("texttoreverse").$1.Get()]),function(a)
    {
     rvReversed.Set(a);
